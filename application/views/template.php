        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url(); ?>gentelella/production/index.html" class="site_title"><i class="fa fa-paw"></i> <span>Gentelella Alela!</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <!-- <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url(); ?>gentelella/production/index.html">Dashboard</a></li>
                      <li><a href="<?php echo base_url(); ?>gentelella/production/index2.html">Dashboard2</a></li>
                      <li><a href="<?php echo base_url(); ?>gentelella/production/index3.html">Dashboard3</a></li>
                    </ul>
                  </li> -->
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     <!--  <li><a href="<?php echo base_url(); ?>gentelella/production/form.html">General Form</a></li> -->
                      <li><a href="<?php echo base_url(); ?>gentelella/production/form_validation.html">Advanced Components</a></li>
                      <li><a href="<?php echo site_url('TemplateControl/loadForm/');?>">Advanced Components</li>
                      <!-- <li><a href="<?php echo base_url(); ?>gentelella/production/form_validation.html">Form Validation</a></li>
                      <li><a href="<?php echo base_url(); ?>gentelella/production/form_wizards.html">Form Wizard</a></li>
                      <li><a href="<?php echo base_url(); ?>gentelella/production/form_upload.html">Form Upload</a></li>
                      <li><a href="<?php echo base_url(); ?>gentelella/production/form_buttons.html">Form Buttons</a></li> -->
                    </ul>
                  </li>
